		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-12 align-self-center content">
					...
					<ol class="breadcrumb pull-right">
						<li class="breadcrumb-item"><a href="<c:url value='/cliente/pedido'/>">Pedido</a></li>
			...
			<div class="row content">
				<div class="col-md-8 offset-md-2">
					<p>
						<a href="<c:url value='/cliente/pedido/add'/>">Realizar novo
							pedido</a>
					</p>
						...
						<table class="table table-hover color-table info-table">
							...
							<tbody>
								<c:forEach var="pedido" items="${pedidos}">
									<tr>
										<td><b><a href="/cliente/pedido/${pedido.id}">${pedido.id}</a></b></td>
